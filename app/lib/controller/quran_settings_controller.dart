import 'package:qalb/data/model/response/haram_food_list_model.dart';
import 'package:qalb/data/model/response/mosque_settings_model.dart';
import 'package:qalb/data/model/response/translator_model.dart';
